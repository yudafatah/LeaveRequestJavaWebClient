    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            <ul class="sidebar navbar-nav bg-dark">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="StaffHistories.jsp">
                ...
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="StaffPage.jsp">Dashboard</a>
                        </li>
                        <li class="breadcrumb-item active"> Manage Leave Request </li>
                    </ol>
                    <%
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" action="../addData" enctype="multipart/form-data">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="typelr" required>
                                                            <%
                                                                if (session.getAttribute("lrtList") != null) {
                                                                    ArrayList<HashMap<String, String>> lrtList = (ArrayList<HashMap<String, String>>) session.getAttribute("lrtList");
                                                                    for (int idx = 0; idx < lrtList.size(); idx++) {
                                                            %>
                                                            <option value="<%= lrtList.get(idx).get("typeLrId")%>"><%= lrtList.get(idx).get("typeName")%></option>    
                                                            <%
                                                                    }
                                                                }
                                                            %>
                                ...
                                <div class="panel basic-default">
                                    <div class="panel-heading">
                                        ...
                                        <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal">
                                            <i class="fa fa-plus"> Add Leave Request</i>
                                        </button><hr>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                        ...
                                                        <tbody>
                                                            <%
                                                                int no = 1;
                                                                if (session.getAttribute("lrList") != null) {
                                                                    ArrayList<HashMap<String, String>> lr = (ArrayList<HashMap<String, String>>) session.getAttribute("lrList");
                                                                    for (int idx = 0; idx < lr.size(); idx++) {
                                                                        if (!lr.get(idx).get("requestStatus").contains("Cancel")) {

                                                            %>
                                                            <tr>
                                                                <td><%= no%></td>
                                                                <td><%= lr.get(idx).get("requestDate")%></td>
                                                                <td><%= lr.get(idx).get("startDate")%></td>
                                                                <td><%= lr.get(idx).get("endDate")%></td>
                                                                <td><%= lr.get(idx).get("noteReject")%></td>
                                                                <%
                                                                    if (lr.get(idx).get("requestStatus").contains("Approved")) {
                                                                %>
                                                                <td style="color: green"><%= lr.get(idx).get("requestStatus")%></td>
                                                                <%
                                                                } else if (lr.get(idx).get("requestStatus").contains("Rejected")) {
                                                                %>
                                                                <td style="color: red"><%= lr.get(idx).get("requestStatus")%></td>
                                                                <%
                                                                } else {
                                                                %>
                                                                <td style="color: #856404"><%= lr.get(idx).get("requestStatus")%></td>
                                                                <%
                                                                    }
                                                                %>
                                                                <%String img = "";
                                                                    if (lr.get(idx).get("image") != null) {
                                                                        byte[] bimg = lr.get(idx).get("image").getBytes();
                                                                        img = new String(bimg);
                                                                    }
                                                                %>
                                                                <td>
                                                                    <a href="data:image/jpg;base64, <%= img%>">
                                                                        <img style="width:100%;max-width:100px" id="myImg" src="data:image/jpg;base64, <%= img%> ">
                                                                    </a>
                                                                </td>
                                                                <td>
                                                                    <%
                                                                        if (lr.get(idx).get("requestStatus").contains("Waiting")) {
                                                                    %>
                                                                    <a href="../update?lrid= <%= lr.get(idx).get("lrId")%> ">
                                                                        <input class="btn btn-danger btn-md" type="button" value="Cancel" onclick="return confirm('Are you sure you want to cancel?')" />
                                                                    </a>
                                                                    <%
                                                                        }else{
                                                                    %>
                                                                    <a href="../update?lrid=<%= lr.get(idx).get("lrId") %>">
                                                                        <input disabled class="btn btn-danger btn-md" type="button" value="Cancel" />
                                                                    </a>
                                                                    <%}%>
                                                                </td>
                                                            </tr>
